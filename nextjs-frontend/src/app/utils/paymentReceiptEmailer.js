        ...
        <body style="margin: 0; padding: 20px; font-family: Arial, sans-serif; background-color: #f5f5f5;">
          ...
          <div id="receipt" class="receipt-container" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="padding: 0 20px 30px 20px;">
              ...
              <!-- Contact Email -->
              <p style="margin: 0 0 20px 0; font-size: 12px; color: ${BRAND_COLORS.darkGray};">
              ...
              <!-- Copyright and Generation Date - properly separated below -->
              <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #eee;">
                <p style="margin: 0 0 8px 0; font-size: 10px; color: #666; text-align: left;">© 2025 ${receiptSettings.conferenceTitle || 'International Nursing Conference 2025'}</p>
                <p style="margin: 0; font-size: 10px; color: #999; text-align: left;">Generated on: ${new Date().toLocaleString()}</p>
              </div>
            </div>
