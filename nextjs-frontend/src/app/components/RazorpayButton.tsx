  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        {/* Powered by section with logo - matching PayPal format */}
        ...
        {/* Security notice text - matching PayPal format */}
