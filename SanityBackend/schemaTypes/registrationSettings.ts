      ...
      fields: [
        {
          ...
          type: 'datetime',
          description: 'Last date and time for early bird pricing',
        ...
        },
        {
          ...
          type: 'datetime',
          description: 'Start date and time for next round pricing',
          validation: Rule => Rule.required(),
        },
        {
          name: 'nextRoundEnd',
          ...
          type: 'datetime',
          description: 'Last date and time for next round pricing',
          validation: Rule => Rule.required(),
        },
        {
          ...
          type: 'datetime',
          description: 'Start date and time for spot registration pricing',
          validation: Rule => Rule.required(),
        },
        {
          ...
          type: 'datetime',
          description: 'Final date and time when registration closes',
          validation: Rule => Rule.required(),
        },
      ],
    }),
